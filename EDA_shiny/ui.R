...
sidebar <- dashboardSidebar(
    sidebarMenu(id = "gtd_pranav",
      ...
      menuItem("Part 1: Global Overview", tabName = "p1_1", icon = icon("globe"),
        menuSubItem("Impact analysis", icon = icon("check-circle"),tabName = "p1_1_impact"),
        menuSubItem("Tab 2", icon = icon("check-circle"), tabName = "p1_2")),
...
body <- dashboardBody(
  ...
  tabItems(
    ...
    #-------------------------------------------- 
    # section 1: Global overview (with sub tabs)
    #-------------------------------------------- 
    tabItem(tabName = "p1_1_impact",
      fluidPage(title = "p1_global_overview",

        fluidRow(
          tabBox(width = 10,
            title = "Characteristics Deadliest Terrorist Groups",
            id = "tabset1", side = "left", height = "610px", 
            tabPanel("Plot1", "", highchartOutput("top10_hc1",height = 600)),
            tabPanel("Tab2", "Tab content 2")
          ),
          tabBox(width = 2,
            title = "Second tabBox",
            id = "tabset2", side = "left", height = "600px", 
            selected = "Tab3",
