...
```{r fig.height= 4, out.width="100%", fig.cap="Auto Arima Forecast (Afghanistan)"}
...
```{r fig.height= 4, out.width="100%", fig.cap="Neural Network Forecast (Afghanistan)"}
# combine plots for latex output
if( knitr:::is_latex_output() ) {
  plot(fore_nn)
}
...
```{r fig.height= 4, out.width="100%", fig.cap="TBATS Forecast (Afghanistan)"}
# combine plots for latex output
if( knitr:::is_latex_output() ) {
  plot(fore_tbats)
}
...
```{r fig.height= 4, out.width="100%", fig.cap="ETS Forecast (Afghanistan)"}
# combine plots for latex output
if( knitr:::is_latex_output() ) {
  plot(fore_ets)
}
...
```{r fig.height= 4, out.width="100%", fig.cap="Auto Arima Forecast (Iraq)"}
# combine plots for latex output
if( knitr:::is_latex_output() ) {
  plot(fore_arima)
}
...
```{r fig.height= 4, out.width="100%", fig.cap="Neural Network Forecast (Iraq)"}
# combine plots for latex output
if( knitr:::is_latex_output() ) {
  plot(fore_nn)
}
...
```{r fig.height= 4, out.width="100%", fig.cap="TBATS Forecast (Iraq)"}
# combine plots for latex output
if( knitr:::is_latex_output() ) {
  plot(fore_tbats)
}
...
```{r fig.height= 4, out.width="100%", fig.cap="ETS Forecast (Iraq)"}
# combine plots for latex output
if( knitr:::is_latex_output() ) {
  plot(fore_ets)
}
...
```{r fig.height= 4, out.width="100%", fig.cap="Auto Arima Forecast (SAHEL Region)"}
# combine plots for latex output
if( knitr:::is_latex_output() ) {
  plot(fore_arima)
}
...
```{r fig.height= 4, out.width="100%", fig.cap="Neural Network Forecast (SAHEL Region)"}
# combine plots for latex output
if( knitr:::is_latex_output() ) {
  plot(fore_nn)
}
...
```{r fig.height= 4, out.width="100%", fig.cap="TBATS Forecast (SAHEL Region)"}
# combine plots for latex output
if( knitr:::is_latex_output() ) {
  plot(fore_tbats)
}
...
```{r fig.height= 4, out.width="100%", fig.cap="ETS Forecast (SAHEL Region)"}
# combine plots for latex output
if( knitr:::is_latex_output() ) {
  plot(fore_ets)
}
